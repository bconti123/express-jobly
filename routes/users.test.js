...
describe("GET /users/:username", function () {
  test("works for users while a correct user is logged in", async function () {
    const resp = await request(app)
      .get(`/users/u1`)
  ...
  test("works for users while an admin logged in", async function () {
    const resp = await request(app)
      .get(`/users/u1`)
      .set("authorization", `Bearer ${AdminToken}`);
    expect(resp.body).toEqual({
...
describe("PATCH /users/:username", () => {
  test("works for users while a correct user logged in", async function () {
    const resp = await request(app)
      .patch(`/users/u1`)
      .send({
        firstName: "New",
  ...
  test("works for users while an admin user logged in", async function () {
    const resp = await request(app)
      .patch(`/users/u1`)
      .send({
        firstName: "New",
